...
<style>
    ...
    body { padding-top: 75px; background: #f7f6f2; font-family: 'Noto Sans TC', sans-serif;}
...
<div class="sidebar" id="sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li class="sidebar-item">
            <a href="admin_withdraw.php" <?php if($currentPage == 'admin_withdraw.php') echo 'class="active"'; ?>>
                <i class="fa-solid fa-money-bill-transfer"></i> 提款審核
            </a>
        </li>
    </ul>
</div>
