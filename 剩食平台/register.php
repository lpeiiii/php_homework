...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $check_store    = mysqli_query($link, "SELECT * FROM store WHERE id='$input_id'");
    ...
    if ($role_type === 'user') {
        ...
        $sql = "INSERT INTO consumer (id, pwd, name, phone, email, allergy, card) 
        ...
        $sql = "INSERT INTO store (id, pwd, name, phone, email, address, intro, menu) 
                VALUES ('$id', '$pwd', '$name', '$phone', '$email', '$address', '$intro', '$menuTargetName')";
    }
