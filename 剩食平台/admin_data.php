...
<style>
  ...
  .page-title { font-size: 2.2rem; font-weight: 700; margin-bottom: 5px; color: var(--text-dark); }
  ...
  /* 📊 三小圖表並排橫列 */
  .three-column-grid {
    display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px; width: 100%; margin-bottom: 24px;
  }
...
<div class="welcome-section">
  <h2 class="page-title">📈 平台數據管理中心</h2>
...
// 💡 註：不要在這裡放 </main></body></html>，因為這些標籤通常由獨立的頁尾（如 footer）引入，
// 或是已經包含在你的後台全域設定中。如果是全手動關閉，可以解除下方註解：
// echo '</main></body></html>';
?>